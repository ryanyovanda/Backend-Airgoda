...
public class CreateUserUsecaseImpl implements CreateUserUsecase {
  ...
  public UserDetailResponseDTO createUser(CreateUserRequestDTO req){
    ...
    return new UserDetailResponseDTO(savedUser.getId(), savedUser.getName(), savedUser.getEmail(), savedUser.getProfilePictureUrl(), savedUser.getIsVerified(),savedUser.getIsOnboardingFinished());
  }
